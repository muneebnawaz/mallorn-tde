...
def main():
    ...
    plot_gp_fit_one_band(lcs_small, best_id, band="g", out_png="gp_best_g.png")
    plot_gp_fit_one_band(lcs_small, best_id, band="r", out_png="gp_best_r.png")

    plot_gp_fit_one_band(lcs_small, worst_id, band="g", out_png="gp_worst_g.png")
    plot_gp_fit_one_band(lcs_small, worst_id, band="r", out_png="gp_worst_r.png")
    ...
    feat.to_csv("debug_features_small.csv", index=False)
    print("\nWrote debug_features_small.csv")
